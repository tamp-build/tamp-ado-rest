...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-ado-rest";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests — Tamp.AdoRest.V7 has no integration tests (PAT-gated; consumers run their own E2E in their own pipeline).")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.AdoRest.V7.Tests" / "Tamp.AdoRest.V7.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.AdoRest.V7" / "Tamp.AdoRest.V7.csproj");
